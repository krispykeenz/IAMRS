        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemperatureWarningThreshold = table.Column<double>(type: "float", nullable: false),
                    TemperatureCriticalThreshold = table.Column<double>(type: "float", nullable: false),
                    VibrationThreshold = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceTickets_Machines_MachineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataQuality = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaintenanceTicketId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Alerts_MaintenanceTickets_MaintenanceTicketId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alerts_MachineId_Severity_CreatedAt",
                table: "Alerts",
                columns: new[] { "MachineId", "Severity", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Alerts_MaintenanceTicketId",
                table: "Alerts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceTickets_MachineId",
